...
<body>
        ...
        person의 toString() : <%= person.toString() %>
         --%>
         
        <hr>
        
        <h3>EL에서 null과 '비어있다'에 대한 처리 방법</h3>
              <!-- 참조X  / 객체는 존재하나 내용(요소)이 없다.  -->
         
         <h4 style ="color:red"> EL은 null과 비어있다를 구분할 수 없다.</h4>
