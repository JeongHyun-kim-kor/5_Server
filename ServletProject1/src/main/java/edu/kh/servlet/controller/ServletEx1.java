...
import javax.servlet.http.HttpServletResponse;import javax.swing.InputMap;

// Controller : 요청에 따라  응답할 코드를 제어

// Servlet 클래스를 만들기 위해서는
// javax.servlet.http.HttpServlet 추상클래스(직접 객체 생성 불가)를 반드시 상속받아야 한다!
// - 요청, 응답을 위한 방법(메서드) 제공
// - tomcat에서 제공하는 클래스
//									추상클래스 : 추상 메서드를 0개 이상 포함한 클래스
//												(이름만 있는 메서드, 상속받은 자식이 무조건 
//                                               오버라이딩 해야함)		
...
//		resp.setCharacterEncoding("UTF-8");  사용 xxx 글자가또 꺠짐
