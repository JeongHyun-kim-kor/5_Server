...
COMMENT ON COLUMN "MEMBER"."MEMBER_NO" IS '회원 번호(SEQ_MEMER_NO)';

COMMENT ON COLUMN "MEMBER"."MEMBER_EMAIL" IS '회원이메일(아이디로 사용)';
...
CREATE TABLE "BOARD" (
	...
	"B.CREATE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"B.UPDATE_DATE"	DATE		NULL,
...
COMMENT ON COLUMN "BOARD"."B.CREATE_DATE" IS '게시글 작성일';

COMMENT ON COLUMN "BOARD"."B.UPDATE_DATE" IS '마지막 수정일(수정시 UPDATE)';

COMMENT ON COLUMN "BOARD"."READ_COUNT" IS '조회수';

COMMENT ON COLUMN "BOARD"."BOARD_DEL_FL" IS '삭제 여부(N : 삭제 X, Y : 삭제 O)';
...
COMMENT ON COLUMN "BOARD_LIKE"."MEMBER_NO" IS '좋아요 누른 회 번호';
...
COMMENT ON COLUMN "COMMENT"."COMMENT_DEL_FL" IS '댓글 삭제 여부(N : 삭제X, Y: 삭제 O)';
...
--DELETE FROM BOARD_TYPE WHERE BOARD_CODE = 7;
...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr','pass02!', '유저이', '01022222222',
...
UPDATE "MEMBER" SET
MEMBER_PW ='$2a$10$KsSfR96pyp4iHfvDLOsVUejiRUSbOJICJUh3oXexeoiPwo7FGQaZi';
...
BEGIN
	FOR I IN 1..2000 LOOP
		...
		VALUES(SEQ_BOARD_NO.NEXTVAL,
			   ...
			   SEQ_BOARD_NO.CURRVAL || '번째 게시글입니다.<br>안녕하헤요.',
			   DEFAULT, DEFAULT, DEFAULT, DEFAULT, 7,
			   CEIL(DBMS_RANDOM.VALUE(0,3))) ; -- 오라클 난수 발생기
	END LOOP;
END;
/
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
 '20221116105843_00003.gif' , '3.gif', 0, 1998 );
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
 '20221116105843_00004.gif' , '4.gif', 0, 1996 );
...
INSERT INTO BOARD_LIKE VALUES(7, 2000);
INSERT INTO BOARD_LIKE VALUES(7, 1999);
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 2000, 5, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 2000, 6, null);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 2000, 2, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 2000, 4, 2001);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 2000, 5, 2001);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 2000, 5, 2002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 2000, 6, 2002);
COMMIT;
...
START WITH PARENT_NO IS NULL  -- PARENT_NO가 NULL일 경우 최상위 부모이다!
  -- 부모 -> 자식 계층 구조
...
-- 서브쿼리를 이용한 INSERT  + UNIIN ALL방법을 통해서 가능
...
WHERE BOARD_NO = 2011
	AND IMG_ORDER = 1 OR IMG_ORDER = 2 OR IMG_ORDER = 4
	-- AND IMG_ORDER IN (1,2,3);
...
-- 작성자 닉네임으로 검색
AND MEMBER_NICKNAME LIKE '%유저%'; -- JOIN 사용
